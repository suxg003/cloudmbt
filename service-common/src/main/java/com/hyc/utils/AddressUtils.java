...
public class AddressUtils {
	...
	public static String getAddresses(String content, String encodingString)
		...
		if (returnStr != null) {
			...
			JSONObject jsonString = JSONObject.parseObject(returnStr);
			Map map = JSON.parseObject(jsonString.getString("data"));
			String ads = map.get("country").toString() + map.get("area")
					+ map.get("region") + map.get("city") + map.get("isp");
			return ads;
		}
		return null;
	}
